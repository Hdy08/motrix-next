export default {
  ...
  'background-image-files': 'Görsel dosyaları',
  'background-image-select-failed': 'Arka plan görseli seçilemedi',
  'background-opacity': 'Arka plan resmi opaklığı',
  'task-pagination-opacity': 'Sayfalama düğmeleri opaklığı',
  'task-list-selected-background-opacity': 'Kategori düğmeleri opaklığı',
  'speed-limit-button': 'Hız sınırı düğmesi',
  'speed-limit-button-opacity': 'Hız sınırı düğmesi opaklığı',
