export default {
  ...
  'background-image-files': 'ملفات الصور',
  'background-image-select-failed': 'تعذر اختيار صورة الخلفية',
  'background-opacity': 'عتامة صورة الخلفية',
  'task-pagination-opacity': 'عتامة أزرار التنقل بين الصفحات',
  'task-list-selected-background-opacity': 'عتامة أزرار التصنيف',
  'speed-limit-button': 'زر حد السرعة',
  'speed-limit-button-opacity': 'عتامة زر حد السرعة',
