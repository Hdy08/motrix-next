export default {
  ...
  'background-image-files': 'Αρχεία εικόνας',
  'background-image-select-failed': 'Αποτυχία επιλογής εικόνας φόντου',
  'background-opacity': 'Αδιαφάνεια εικόνας φόντου',
  'task-pagination-opacity': 'Αδιαφάνεια κουμπιών σελιδοποίησης',
  'task-list-selected-background-opacity': 'Αδιαφάνεια κουμπιών κατηγορίας',
  'speed-limit-button': 'Κουμπί ορίου ταχύτητας',
  'speed-limit-button-opacity': 'Αδιαφάνεια κουμπιού ορίου ταχύτητας',
