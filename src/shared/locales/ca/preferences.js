export default {
  ...
  'bt-peer-blocklist-update-failed-keeping-current': 'BT Peer: No s\'ha pogut actualitzar; es mantenen les regles actuals',
  ...
  'background-image-files': 'Fitxers d\'imatge',
  'background-image-select-failed': 'No s\'ha pogut seleccionar la imatge de fons',
  'background-opacity': 'Opacitat de la imatge de fons',
  'task-pagination-opacity': 'Opacitat dels botons de paginació',
  'task-list-selected-background-opacity': 'Opacitat dels botons de categoria',
  'speed-limit-button': 'Botó de límit de velocitat',
  'speed-limit-button-opacity': 'Opacitat del botó de límit de velocitat',
