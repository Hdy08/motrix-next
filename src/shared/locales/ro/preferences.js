export default {
  ...
  'background-image-files': 'Fișiere imagine',
  'background-image-select-failed': 'Nu s-a putut selecta imaginea de fundal',
  'background-opacity': 'Opacitatea imaginii de fundal',
  'task-pagination-opacity': 'Opacitatea butoanelor de paginare',
  'task-list-selected-background-opacity': 'Opacitatea butoanelor de categorie',
  'speed-limit-button': 'Buton limită de viteză',
  'speed-limit-button-opacity': 'Opacitatea butonului limită de viteză',
