export default {
  ...
  'background-image-files': 'Bildefiler',
  'background-image-select-failed': 'Kunne ikke velge bakgrunnsbilde',
  'background-opacity': 'Bakgrunnsbildeopasitet',
  'task-pagination-opacity': 'Opasitet for pagineringsknapper',
  'task-list-selected-background-opacity': 'Opasitet for kategoriknapper',
  'speed-limit-button': 'Fartsgrenseknapp',
  'speed-limit-button-opacity': 'Opasitet for fartsgrenseknapp',
