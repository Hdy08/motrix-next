export default {
  ...
  'background-image-files': 'Файлове с изображения',
  'background-image-select-failed': 'Неуспешен избор на фоново изображение',
  'background-opacity': 'Непрозрачност на фоновото изображение',
  'task-pagination-opacity': 'Непрозрачност на бутоните за странициране',
  'task-list-selected-background-opacity': 'Непрозрачност на бутоните за категории',
  'speed-limit-button': 'Бутон за ограничение на скоростта',
  'speed-limit-button-opacity': 'Непрозрачност на бутона за ограничение на скоростта',
