export default {
  ...
  'open-task-list-on-start-notification-click': 'Открывать список задач при нажатии на уведомление о запуске',
  ...
  'background-image-files': 'Файлы изображений',
  'background-image-select-failed': 'Не удалось выбрать фоновое изображение',
  'background-opacity': 'Непрозрачность фонового изображения',
  'task-pagination-opacity': 'Непрозрачность кнопок пагинации',
  'task-list-selected-background-opacity': 'Непрозрачность кнопок категорий',
  'speed-limit-button': 'Кнопка ограничения скорости',
  'speed-limit-button-opacity': 'Непрозрачность кнопки ограничения скорости',
