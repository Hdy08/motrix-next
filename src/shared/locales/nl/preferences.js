export default {
  ...
  'background-image-files': 'Afbeeldingsbestanden',
  'background-image-select-failed': 'Kan achtergrondafbeelding niet selecteren',
  'background-opacity': 'Opaciteit van achtergrondafbeelding',
  'task-pagination-opacity': 'Dekking van paginatieknoppen',
  'task-list-selected-background-opacity': 'Opaciteit van categorieknoppen',
  'speed-limit-button': 'Snelheidslimietknop',
  'speed-limit-button-opacity': 'Dekking van snelheidslimietknop',
