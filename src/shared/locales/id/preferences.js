export default {
  ...
  'bt-peer-blocklist-update-failed-keeping-current': 'BT Peer: Daftar blokir gagal diperbarui; aturan saat ini tetap aktif',
  ...
  'background-image-files': 'File gambar',
  'background-image-select-failed': 'Gagal memilih gambar latar belakang',
  'background-opacity': 'Opasitas gambar latar belakang',
  'task-pagination-opacity': 'Opasitas tombol paginasi',
  'task-list-selected-background-opacity': 'Opasitas tombol kategori',
  'speed-limit-button': 'Tombol batas kecepatan',
  'speed-limit-button-opacity': 'Opasitas tombol batas kecepatan',
