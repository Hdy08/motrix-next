export default {
  ...
  'background-image-files': 'Image files',
  'background-image-select-failed': 'Failed to select background image',
  'background-opacity': 'Background image opacity',
  'task-pagination-opacity': 'Pagination button opacity',
  'task-list-selected-background-opacity': 'Category button opacity',
  'speed-limit-button': 'Speed limit button',
  'speed-limit-button-opacity': 'Speed limit button opacity',
