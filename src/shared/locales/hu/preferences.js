export default {
  ...
  'background-image-files': 'Képfájlok',
  'background-image-select-failed': 'Nem sikerült kiválasztani a háttérképet',
  'background-opacity': 'Háttérkép opacitása',
  'task-pagination-opacity': 'Lapozógombok opacitása',
  'task-list-selected-background-opacity': 'Kategóriagombok opacitása',
  'speed-limit-button': 'Sebességkorlát gomb',
  'speed-limit-button-opacity': 'Sebességkorlát gomb opacitása',
