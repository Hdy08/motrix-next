export default {
  ...
  'bt-peer-blocklist-update-failed-keeping-current': 'BT Peer: Không thể cập nhật; các quy tắc hiện tại vẫn được áp dụng',
  ...
  'background-image-files': 'Tệp hình ảnh',
  'background-image-select-failed': 'Không thể chọn ảnh nền',
  'background-opacity': 'Độ mờ của ảnh nền',
  'task-pagination-opacity': 'Độ mờ của nút phân trang',
  'task-list-selected-background-opacity': 'Độ mờ của nút danh mục',
  'speed-limit-button': 'Nút giới hạn tốc độ',
  'speed-limit-button-opacity': 'Độ mờ của nút giới hạn tốc độ',
