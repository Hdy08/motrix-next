export default {
  ...
  'background-image-files': '画像ファイル',
  'background-image-select-failed': '背景画像の選択に失敗しました',
  'background-opacity': '背景画像の不透明度',
  'task-pagination-opacity': 'ページ切り替えボタンの不透明度',
  'task-list-selected-background-opacity': 'カテゴリボタンの不透明度',
  'speed-limit-button': '速度制限ボタン',
  'speed-limit-button-opacity': '速度制限ボタンの不透明度',
