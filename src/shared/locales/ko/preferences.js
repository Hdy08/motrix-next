export default {
  ...
  'bt-peer-blocklist-update-failed-keeping-current': 'BT Peer: 차단 목록을 업데이트하지 못했습니다. 기존 규칙을 계속 사용합니다',
  'bt-tracker': '트래커 서버',
  ...
  'background-image-files': '이미지 파일',
  'background-image-select-failed': '배경 이미지를 선택하지 못했습니다',
  'background-opacity': '배경 이미지 불투명도',
  'task-pagination-opacity': '페이지 전환 버튼 불투명도',
  'task-list-selected-background-opacity': '분류 버튼 불투명도',
  'speed-limit-button': '속도 제한 버튼',
  'speed-limit-button-opacity': '속도 제한 버튼 불투명도',
