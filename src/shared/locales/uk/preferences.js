export default {
  ...
  'open-folder-on-notification-click': 'Відкривати папку збереження при натисканні сповіщення про завершення',
  'open-task-list-on-start-notification-click': 'Відкривати список завдань після натискання сповіщення про початок',
  ...
  'background-image-files': 'Файли зображень',
  'background-image-select-failed': 'Не вдалося вибрати фонове зображення',
  'background-opacity': 'Непрозорість фонового зображення',
  'task-pagination-opacity': 'Непрозорість кнопок пагінації',
  'task-list-selected-background-opacity': 'Непрозорість кнопок категорій',
  'speed-limit-button': 'Кнопка обмеження швидкості',
  'speed-limit-button-opacity': 'Непрозорість кнопки обмеження швидкості',
