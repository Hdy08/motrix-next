export default {
  ...
  'background-image-files': 'Pliki obrazów',
  'background-image-select-failed': 'Nie udało się wybrać obrazu tła',
  'background-opacity': 'Krycie obrazu tła',
  'task-pagination-opacity': 'Krycie przycisków stronicowania',
  'task-list-selected-background-opacity': 'Krycie przycisków kategorii',
  'speed-limit-button': 'Przycisk limitu prędkości',
  'speed-limit-button-opacity': 'Krycie przycisku limitu prędkości',
