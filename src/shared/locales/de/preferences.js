export default {
  ...
  'background-image-files': 'Bilddateien',
  'background-image-select-failed': 'Hintergrundbild konnte nicht ausgewählt werden',
  'background-opacity': 'Deckkraft des Hintergrundbilds',
  'task-pagination-opacity': 'Deckkraft der Seitenschaltflächen',
  'task-list-selected-background-opacity': 'Deckkraft der Kategorieschaltflächen',
  'speed-limit-button': 'Geschwindigkeitslimit-Schaltfläche',
  'speed-limit-button-opacity': 'Deckkraft der Geschwindigkeitslimit-Schaltfläche',
