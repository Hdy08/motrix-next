export default {
  ...
  'background-image-files': 'فایل‌های تصویری',
  'background-image-select-failed': 'انتخاب تصویر پس‌زمینه ناموفق بود',
  'background-opacity': 'کدری تصویر پس‌زمینه',
  'task-pagination-opacity': 'کدری دکمه‌های صفحه‌بندی',
  'task-list-selected-background-opacity': 'کدری دکمه‌های دسته‌بندی',
  'speed-limit-button': 'دکمه محدودیت سرعت',
  'speed-limit-button-opacity': 'کدری دکمه محدودیت سرعت',
