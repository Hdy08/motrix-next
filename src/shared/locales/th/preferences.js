export default {
  ...
  'background-image-files': 'ไฟล์รูปภาพ',
  'background-image-select-failed': 'เลือกรูปภาพพื้นหลังไม่สำเร็จ',
  'background-opacity': 'ความทึบของภาพพื้นหลัง',
  'task-pagination-opacity': 'ความทึบของปุ่มเปลี่ยนหน้า',
  'task-list-selected-background-opacity': 'ความทึบของปุ่มหมวดหมู่',
  'speed-limit-button': 'ปุ่มจำกัดความเร็ว',
  'speed-limit-button-opacity': 'ความทึบของปุ่มจำกัดความเร็ว',
